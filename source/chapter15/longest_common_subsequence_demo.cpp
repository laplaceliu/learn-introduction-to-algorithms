...
void test_classic_examples() {
  ...
  if (result1.length == 4 &&
      (result1.lcs_string == "BCAB" || result1.lcs_string == "BDAB")) {
...
void test_edge_cases() {
  ...
  std::cout << "  最长公共子序列长度: " << result1.length << std::endl;
  std::cout << "  最长公共子序列: \"" << result1.lcs_string << "\""
            << std::endl;
  ...
  std::cout << "  最长公共子序列长度: " << result2.length << std::endl;
  std::cout << "  最长公共子序列: \"" << result2.lcs_string << "\""
            << std::endl;
...
void test_algorithm_correctness() {
  ...
  std::vector<TestCase> test_cases = {{"A", "A", 1, {"A"}},
                                      {"A", "B", 0, {""}},
                                      {"AB", "BA", 1, {"A", "B"}},
                                      {"ABCD", "ACBD", 3, {"ABD", "ACD"}},
  ...
  for (const auto &test_case : test_cases) {
    ...
    std::cout << "测试: \"" << test_case.seq1 << "\" 和 \"" << test_case.seq2
              << "\"" << std::endl;
    std::cout << "  期望长度: " << test_case.expected_length
              << ", 实际长度: " << result.length << std::endl;
