...
void test_adjacency_list_operations() {
    ...
    std::cout << "  是有向图: " << (graph.is_directed() ? "是" : "否") << std::endl;
...
void test_edge_cases() {
    ...
    std::cout << "\n单节点图测试:" << std::endl;
    std::cout << "  节点数量: " << single_node_graph.get_node_count() << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "  边1->1的权重: " << self_loop_graph.get_edge_weight(1, 1) << std::endl;
