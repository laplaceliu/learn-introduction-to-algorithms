...
void test_basic_operations() {
  ...
  // 测试查找
  std::cout << "查找 4: " << (bst.search(4) != nullptr ? "找到" : "未找到")
            << std::endl;
  std::cout << "查找 10: " << (bst.search(10) != nullptr ? "找到" : "未找到")
            << std::endl;
...
void test_delete_operations() {
  ...
  // 测试删除叶子节点
  std::cout << "删除叶子节点 2: " << (bst.remove(2) ? "成功" : "失败")
            << std::endl;
  std::cout << "删除后中序遍历: ";
  ...
  // 测试删除只有一个子节点的节点
  std::cout << "删除只有一个子节点的节点 7: "
            << (bst.remove(7) ? "成功" : "失败") << std::endl;
  std::cout << "删除后中序遍历: ";
  ...
  // 测试删除有两个子节点的节点
  std::cout << "删除有两个子节点的节点 6: " << (bst.remove(6) ? "成功" : "失败")
            << std::endl;
  std::cout << "删除后中序遍历: ";
  ...
  // 测试删除根节点
  std::cout << "删除根节点 15: " << (bst.remove(15) ? "成功" : "失败")
            << std::endl;
  std::cout << "删除后中序遍历: ";
...
void test_edge_cases() {
  ...
  std::cout << "空树是否为空: " << (empty_bst.empty() ? "是" : "否")
            << std::endl;
  ...
  std::cout << "是否有效BST: " << (duplicate_bst.is_valid() ? "是" : "否")
            << std::endl;
  std::cout << std::endl;
}
...
void test_string_bst() {
  ...
  // 测试查找
  std::cout << "查找 'banana': "
            << (string_bst.search("banana") != nullptr ? "找到" : "未找到")
            << std::endl;
  std::cout << "查找 'fig': "
            << (string_bst.search("fig") != nullptr ? "找到" : "未找到")
            << std::endl;

  std::cout << "是否有效BST: " << (string_bst.is_valid() ? "是" : "否")
            << std::endl;
  std::cout << std::endl;
}
