#include "../../include/string_matching.h"
#include <iostream>
#include <vector>
#include <string>
#include <chrono>
...
void test_performance_comparison() {
    ...
    auto rk_duration = std::chrono::duration_cast<std::chrono::microseconds>(end - start);
    
    // 有限自动机算法性能
    start = std::chrono::high_resolution_clock::now();
    auto fa_matches = FiniteAutomatonMatcher::search(long_text, pattern);
    end = std::chrono::high_resolution_clock::now();
    auto fa_duration = std::chrono::duration_cast<std::chrono::microseconds>(end - start);
    
    // KMP算法性能
    start = std::chrono::high_resolution_clock::now();
    auto kmp_matches = KMPMatcher::search(long_text, pattern);
    end = std::chrono::high_resolution_clock::now();
    auto kmp_duration = std::chrono::duration_cast<std::chrono::microseconds>(end - start);
...
void test_edge_cases() {
    ...
    auto special_matches = FiniteAutomatonMatcher::search(special_text, special_pattern);
