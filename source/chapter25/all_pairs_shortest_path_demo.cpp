...
void test_matrix_multiplication() {
  ...
  // 运行矩阵乘法算法
  auto result =
      MatrixMultiplicationShortestPath::find_all_pairs_shortest_path(graph);
...
void test_edge_cases() {
  ...
  auto single_result =
      FloydWarshall::find_all_pairs_shortest_path(single_node_graph);
  ...
  auto disconnected_result =
      FloydWarshall::find_all_pairs_shortest_path(disconnected_graph);
