...
void test_singly_linked_list() {
  ...
  std::cout << "初始链表是否为空: " << (list.empty() ? "是" : "否")
            << std::endl;
...
void test_doubly_linked_list() {
  ...
  std::cout << "初始双向链表是否为空: " << (dlist.empty() ? "是" : "否")
            << std::endl;
...
void test_circular_linked_list() {
  ...
  std::cout << "初始循环链表是否为空: " << (clist.empty() ? "是" : "否")
            << std::endl;
...
void test_edge_cases() {
  ...
  std::cout << "删除后链表是否为空: " << (single_list.empty() ? "是" : "否")
            << std::endl;
...
void test_linked_list_applications() {
  ...
  std::cout << "可以向前导航到: " << browser_history.get_tail()->prev->data
            << std::endl;
