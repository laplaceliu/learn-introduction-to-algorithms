...
public:
     ...
     * @return 排序后的数组
     */
    static std::vector<int> counting_sort_general(const std::vector<int>& arr, int min_val, int max_val) {
        if (arr.empty()) return {};
     ...
     * @return 按当前位排序后的数组
     */
    static std::vector<int> counting_sort_by_digit(const std::vector<int>& arr, int exp) {
     ...
     * @return 排序后的数组
     */
    static std::vector<double> bucket_sort_general(const std::vector<double>& arr, double min_val, double max_val) {
        if (arr.empty()) return {};
